...
# datatier.py
#
# Executes SQL queries against an sqlite3 database.
#
# Original author:
#   Prof. Joe Hummel
...
# can be parameterized using ?, in which case pass the
...
# The query can be parameterized using ?, in which case
...
# using ?, in which case pass the values as a list
# [value1, value2, ...]
#
